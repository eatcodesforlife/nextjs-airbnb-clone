...
const LargeCard = () => {
  return (
     <article className='relative flex flex-col-reverse h-screen lg:block lg:h-96' >      
      ...
      <div className='bg-gray-700 h-3/6 pt-5 flex flex-col items-center px-5 rounded-tl-2xl rounded-tr-2xl lg:h-96 lg:absolute lg:top-32 lg:left-12 lg:bg-transparent lg:p-0 lg:place-items-start' >
